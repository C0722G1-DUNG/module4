...
iBlogRepository.save(blog);
    ...
    @Override
    public Page<Blog> searchAuthor(String author,Pageable pageable) {
        return iBlogRepository.searchAuthor(author, pageable);
    }

    @Override
    public List<Blog> findByAuthorContains(String author) {
        return iBlogRepository.findByAuthorContains(author);
    }
}
