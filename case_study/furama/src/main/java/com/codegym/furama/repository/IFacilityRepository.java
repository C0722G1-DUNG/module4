...
//    Page<Facility> searchAndShow(@Param("nameType")String nameType,@Param("name") String name, Pageable pageable );
    ...
    @Query(value="select f.id, f.area ,f.cost,f.description_other_covenience,f.facility_free,f.max_people,f.name,f.number_of_floors,f.poll_area,f.standard_room,f.facility_type_id,f.rent_type_id,ft.name as `type`,r.name as rent\n" +
            ...
            ,countQuery="select * from (select f.id, f.area ,f.cost,f.description_other_covenience,f.facility_free,f.max_people,f.name,f.number_of_floors,f.poll_area,f.standard_room,f.facility_type_id,f.rent_type_id,ft.name as `type`,r.name as rent\n" +
